...
banned_words = [
    ...
    'double dong', 'double penetration', 'dp action', 'dry hump', 'eat my ass', 'ejaculation', 'fecal', 
    ...
    'gang bang', 'gay sex', 'giant cock', 'ginga', 'ginger', 'girls gone wild', 'goatcx', 'goatse', 
    ...
    'menage a trois', 'missionary position', 'motherfucker', 'mound of venus', 'mr hands', 'nambla', 
    'nawashi', 'negro', 'nigga', 'nigger', 'nig nog', 'nipple', 
    'nympho', 'nymphomania', 'omorashi', 'one cup two girls', 'one guy one jar', 
    ...
    'shaved beaver', 'shaved pussy', 'sheep shag', 'shit', 'sh1t', 'shota', 'shrimping', 'skeet', 
    'slanteye', 'slut', 's&m', 'snatch', 'snowballing', 'sodomize', 'sodomy', 'spic ', 
